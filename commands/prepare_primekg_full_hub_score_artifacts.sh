...
ARTIFACT_ROOT="${ARTIFACT_ROOT:-results/mia_v2_primekg-full-nosource_eval/hasi/artifacts/hub_scores}"
...
for seed in 42 123 2024; do
  manifest_dir="$ARTIFACT_ROOT/primekg-full-nosource/seed${seed}"
